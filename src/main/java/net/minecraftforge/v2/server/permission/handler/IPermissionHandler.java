...
public interface IPermissionHandler
{
    ...
    /**
     * <strong>Mods must use {@link PermissionAPI#getPermission(ServerPlayerEntity, PermissionNode, PermissionDynamicContext[])}</strong>
     *
     ...
     */
    <T> T getPermission(ServerPlayerEntity player, PermissionNode<T> node, PermissionDynamicContext<?>... context);

    /**
     * See {@link IPermissionHandler#getPermission(ServerPlayerEntity, PermissionNode, PermissionDynamicContext[])}
     *
