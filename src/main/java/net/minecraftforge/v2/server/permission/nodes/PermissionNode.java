 ...
 * That instance should then be reused every-time a permission check needs to be performed via {@link net.minecraftforge.v2.server.permission.PermissionAPI#getPermission(ServerPlayerEntity, PermissionNode, PermissionDynamicContext[])}.</p>
 */
public final class PermissionNode<T>
{
     ...
     * You may use {@link net.minecraft.util.text.ITextComponent#of(String)} (String) translatable components}, but you'll
     ...
     */
    public PermissionNode<?> setInformation(@Nonnull ITextComponent readableName, @Nonnull ITextComponent description)
    {
    ...
    public interface PermissionResolver<T>
    {
         ...
         */
        T resolve(@Nullable ServerPlayerEntity player, UUID playerUUID, PermissionDynamicContext<?>... context);
    }
    ...
    public boolean equals(Object o)
    {
        ...
        if (!(o instanceof PermissionNode<?>)) return false;
